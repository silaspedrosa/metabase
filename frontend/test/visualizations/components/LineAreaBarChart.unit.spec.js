...
describe("LineAreaBarChart", () => {
    ...
    it("should let you combine series with numbers only", () => {
        expect(
            LineAreaBarChart.seriesAreCompatible(numberCard, numberCard)
        ).toBe(true);
    });
    ...
    it("should not let you combine series with datetimes and numbers", () => {
        expect(
            LineAreaBarChart.seriesAreCompatible(numberCard, dateTimeCard)
        ).toBe(false);
        expect(
            LineAreaBarChart.seriesAreCompatible(dateTimeCard, numberCard)
        ).toBe(false);
    });
});
