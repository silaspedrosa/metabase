                ...
                <div className="py2">
                    {entities ? (
                        ...
                        <DataSelector
                            ...
                            databases={Object.values(databases).map(
                                database => ({
                                    ...database,
                                    tables: database.tables.map(
                            ...
                            disabledSegmentIds={selectedIdTypePairs
                                .filter(
                                    idTypePair => idTypePair[1] === "segment"
                                )
                                .map(idTypePair => idTypePair[0])}
                ...
                {type === "metric" && (
                    <div className={cx("mb2", { disabled: disabled })}>
                        ...
                        <Select
                            ...
                            disabledOptionIds={
                                ...
                                formField.important_fields.value.length === 3
                                    ? fieldsByMetric
                                          .filter(
                                              field =>
                                                  !formField.important_fields.value.includes(
                                                      field
                                                  )
                                          )
                                          .map(field => field.id)
                            ...
                            disabled={
                                formField.id.value === null ||
                                formField.id.value === undefined
                            }
                        />
                    </div>
                )}
