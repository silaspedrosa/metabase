                ...
                >
                    {() => (
                        <div className="wrapper wrapper--trim">
                            ...
                            <GuideEditSection
                                isCollapsed={
                                    most_important_dashboard.id.value ===
                                    undefined
                                }
                                isDisabled={
                                    !dashboards ||
                            ...
                            >
                                <div>
                                    ...
                                    <GuideDetailEditor
                                        ...
                                        removeField={() => {
                                            most_important_dashboard.id.onChange(
                                                null
                                            );
                                                ...
                                                <GuideDetailEditor
                                                    ...
                                                    removeField={() => {
                                                        if (
                                                            ...
                                                            return metricFields.removeField(
                                                                index
                                                            );
                                                        }
                                                        metricField.id.onChange(
                                                            null
                                                        );
                            ...
                            <GuideEditSection
                                isCollapsed={
                                    important_segments_and_tables.length === 0
                                }
                                isDisabled={
                                    (!segments ||
                                        ...
                                        {important_segments_and_tables.map(
                                            (
                                                ...
                                                <GuideDetailEditor
                                                    ...
                                                    removeField={() => {
                                                        if (
                                                            segmentOrTableFields.length >
                                                            1
                                                        ) {
                                                            return segmentOrTableFields.removeField(
                                                                index
                                                            );
                                                        }
                                                        segmentOrTableField.id.onChange(
                                                            null
                                                        );
                                                        segmentOrTableField.type.onChange(
                                                            null
                                                        );
