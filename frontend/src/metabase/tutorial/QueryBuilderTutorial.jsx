...
const QUERY_BUILDER_STEPS = [
    ...
    },
    {
        ...
        getModal: props => (
            <div className="text-centered">
                ...
                <p
                >{t`Click the plus button and select the "Created At" field.`}</p>
            </div>
        ),
        shouldAllowEvent: e =>
            qs(".GuiBuilder-filtered-by a").contains(e.target)
    },
    {
        getPortalTarget: () => qs(".GuiBuilder-filtered-by"),
    ...
    },
    {
        ...
        shouldAllowEvent: e =>
            qs('[data-ui-tag="add-filter"]').contains(e.target)
    },
    {
        ...
        shouldAllowEvent: e =>
            qs(".View-section-aggregation").contains(e.target)
    },
    {
        getPortalTarget: () => qs(".Query-section-aggregation"),
    ...
    },
    {
        ...
        shouldAllowEvent: e =>
            qs(".FieldList-grouping-trigger").contains(e.target)
    },
    {
        getPortalTarget: () => qs(".Query-section-breakout"),
    ...
    },
    {
        ...
        getModal: props => (
            <div className="text-centered">
                ...
                />
                <h3
                >{t`You can view your results as a chart instead of a table.`}</h3>
                <p
