...
export class ObjectDetail extends Component {
        ...
        if (isColumn) {
            ...
            if (value === null || value === undefined || value === "") {
                ...
                if (typeof cellValue === "string") {
                    cellValue = (
                        <ExpandableString str={cellValue} length={140} />
                    );
                }
            }
            clicked = {
    ...
    renderRelationships() {
        ...
        if (tableForeignKeys.length < 1) {
            return (
                <p className="my4 text-centered">{t`No relationships found.`}</p>
            );
        }
        ...
        const relationships = tableForeignKeys
            ...
            .map(fk => {
                ...
                let fkReference;
                const referenceClasses = cx(
                    "flex align-center my2 pb2 border-bottom",
                    {
    ...
    render() {
        ...
        return (
            <div className="ObjectDetail rounded mt2">
                ...
                <div
                    className={cx(
                        "fixed left cursor-pointer text-brand-hover lg-ml2",
                        {
                            disabled: idValue <= 1
                        }
                    )}
