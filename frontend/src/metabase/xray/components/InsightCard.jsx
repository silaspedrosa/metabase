        ...
        return (
            <InsightText>
                {jt`Most of the values for ${model.display_name ||
                    model.name} are between ${<b>{lower}</b>} and ${(
                    <b>{upper}</b>
                )}.`}
            </InsightText>
        );
    ...
    render() {
        ...
        return (
            <InsightText>
                ...
                {table && (
                    <span>
                        <Link to={viewAllRowsUrl}>View all rows</Link> with
                        missing value.
                    </span>
                )}
            </InsightText>
    ...
    render() {
        return (
            <InsightText>
                ...
                >
                    multimodal
                </TermWithDefinition>. This is often the case when different
                segments of data are mixed together.
            </InsightText>
        );
    }
}
...
export class TrendInsight extends Component {
    ...
    render() {
        ...
        return (
            <InsightText
            >{jt`Your data seems to be ${mode} ${shape}.`}</InsightText>
        );
    }
}
