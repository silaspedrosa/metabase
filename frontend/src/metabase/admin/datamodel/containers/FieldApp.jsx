        ...
        if (!_.isEmpty(field.dimensions)) {
            await updateFieldDimension(field.id, {
                ...
                human_readable_field_id:
                    field.dimensions.human_readable_field_id,
                name
            });
        }
...
export class FieldRemapping extends Component {
    ...
    getForeignKeys = () => {
        ...
        const filteredFKs = unfilteredFks.filter(
            fk => fk.field.id === field.id
        );

        return filteredFKs.map(filteredFK => ({
            field: filteredFK.field,
            dimension: filteredFK.dimension,
            dimensions: filteredFK.dimensions.filter(
                this.isValidFKRemappingTarget
            )
        }));
    };
    ...
    render() {
        ...
        const fkMappingField =
            hasFKMappingValue &&
            fields[field.dimensions.human_readable_field_id];
