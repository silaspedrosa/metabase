        ...
        PermissionsApi.deleteGroup({ id: group.id }).then(
            () => {
                const newGroups = sortGroups(
                    _.reject(groups, g => g.id === group.id)
                );
                this.setState({
                    groups: newGroups
                });
        ...
        return (
            ...
            >
                <GroupsTable
                    ...
                    onAddGroupTextChanged={this.onAddGroupTextChanged.bind(
                        this
                    )}
                    onEditGroupClicked={this.onEditGroupClicked.bind(this)}
                    onEditGroupTextChange={this.onEditGroupTextChange.bind(
                        this
                    )}
                    onEditGroupCancelClicked={this.onEditGroupCancelClicked.bind(
                        this
                    )}
                    onEditGroupDoneClicked={this.onEditGroupDoneClicked.bind(
                        this
                    )}
