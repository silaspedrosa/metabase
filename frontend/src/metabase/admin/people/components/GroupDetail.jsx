...
export default class GroupDetail extends Component {
    ...
    async onRemoveUserClicked(membership) {
        try {
            await PermissionsApi.deleteMembership({
    ...
    getMembers() {
        return (
            this.state.members ||
            (this.props.group && this.props.group.members) ||
            []
        );
    }
        ...
        return (
            <AdminPaneLayout
                ...
                buttonAction={
                    canEditMembership(group)
                        ? this.onAddUsersClicked.bind(this)
                        : null
                }
            ...
            >
                ...
                <MembersTable
                    ...
                    onUserSuggestionAccepted={this.onUserSuggestionAccepted.bind(
                        this
                    )}
                    onRemoveUserFromSelection={this.onRemoveUserFromSelection.bind(
                        this
                    )}
