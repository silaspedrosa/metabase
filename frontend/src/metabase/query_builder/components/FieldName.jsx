    ...
    render() {
        ...
        if (field) {
            ...
            if (dimension) {
                ...
                parts.push(
                    <span key="field">
                        {this.displayNameForFieldLiteral(
                            tableMetadata,
                            field[1]
                        )}
                    </span>
            ...
            parts.push(
                <span key="field" className={"text-grey-2"}>{t`field`}</span>
            );
        }
