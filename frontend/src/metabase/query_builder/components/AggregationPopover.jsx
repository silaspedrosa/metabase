...
export default class AggregationPopover extends Component {
    ...
    render() {
            ...
            sections.push({
                ...
                items: availableAggregations.map(aggregation => ({
                    ...
                    isSelected: agg =>
                        ...
                        AggregationClause.getAggregation(agg) ===
                            aggregation.short,
        ...
        if (!showOnlyProvidedAggregations) {
            ...
            let metrics =
                ...
                tableMetadata.metrics.filter(
                    mtrc =>
                        mtrc.is_active === true ||
                        (selectedAggregation &&
                            selectedAggregation.id === mtrc.id)
                );
                ...
                sections.push({
                    ...
                    items: metrics.map(metric => ({
                        ...
                        isSelected: aggregation =>
                            AggregationClause.getMetric(aggregation) ===
                            metric.id,
                        metric: metric
                    })),
                    icon: "staroutline"
            ...
            if (
                tableMetadata.db.features.indexOf("expression-aggregations") >=
                0
            ) {
                sections.push({
        ...
        if (editingAggregation) {
                ...
                <div style={{ width: editingAggregation ? 500 : 300 }}>
                    ...
                    <div className="p1">
                        ...
                        <Button
                            ...
                            onClick={() =>
                                this.commitAggregation(this.state.aggregation)
                            }
                        >
                            {t`Done`}
                        </Button>
            ...
            return (
                <AccordianList
                    ...
                    getItemClasses={item =>
                        item.metric && !item.metric.is_active
                            ? "text-grey-3"
                            : null
                    }
